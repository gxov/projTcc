...
$conn = connect();
$sql = "SELECT foto FROM tb_usuarios WHERE username = '" . $_SESSION['username'] ."'";
...
<div class="userMenuDiv" id="userAccess" style="display: none;">
    <div class="userMenuCont flex">
        <div class="userMenuItem userMenuAccess flexColumn alignCenter">
            <img style="height: 7rem;" class="userMenuPicture" src="http://localhost/projTcc/Web/src/fotos/usuario/' .
            $image .
            '">
            </img>' .
            $_SESSION['username'] . '
        ...
        <div class="userMenuItem flex alignSlfCent justifyContCent alignCenter flex userConfigAccess">
            <svg class="svgConfigAccess" data-v-9ba4cb7e="" data-v-8a0f6996="" xmlns="http://www.w3.org/2000/svg"
                width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
        ...
        echo '<div class="userMenuDiv" id="userAccess" style="display: none;">
    <div class="userMenuCont flex">
        <div class="userMenuItem userMenuAccess flexColumn alignCenter">
