                        ...
                        <div class="sectionWrapper flex">
                                ...
                                <div class="sectionContent flexColumn">
                                    <div class="sectionCardRow flex size12">
                                        <div class="sectionCardColumnCapa">
                                            <img class="sectionCardColumnImg" src="../SRC/capas/1.jpg">
                                        </div>
                                        <div class="sectionCardRowContent">
                                            ...
                                            <div class="sectionRowDesc">
                                                ...
                                                laudantium ducimus quis dicta, nihil deserunt deleniti rerum voluptates
                                                nemo sunt fugiat ratione veniam consequatur molestias voluptas. Minima
                                                iste fugiat facere.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sectionCardRow flex size12">
                                        <div class="sectionCardColumnCapa">
                                            <img class="sectionCardColumnImg" src="../SRC/capas/2.jpg">
                                        </div>
                                        <div class="sectionCardRowContent">
                                            <div class="sectionCardRowTitulo">
                                    ...
                                    <div class="sectionCardRow flex size12">
                                        <div class="sectionCardColumnCapa">
                                            <img class="sectionCardColumnImg" src="../SRC/capas/3.jpg">
                                        </div>
                                        <div class="sectionCardRowContent">
                                            <div class="sectionCardRowTitulo">
                                                Redescobrindo o Cosmos Integral: Física, Metafísica, e Causalidade
                                                Vertical
                                            </div>
                                            <div class="sectionCardRowCategories">
                                                <div class="sectionCardRowBadge">
                            ...
                            <div class="size6">
                                ...
                                <div class="sectionContent flexColumn">
                                    <div class="sectionCardRow flex size12">
                                        <div class="sectionCardColumnCapa">
                                            <img class="sectionCardColumnImg" src="../SRC/capas/4.jpg">
                                        </div>
                                        <div class="sectionCardRowContent">
                                            <div class="sectionCardRowTitulo">
                                                Casa das Folhas
